...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#333333] text-white pt-16 pb-8 border-t border-slate-700">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8 pb-12 border-b border-slate-700/80">
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-xs text-[#A5A5A5]">
              ...
              <li><Link href="/payment" className="text-[#72AFDB] hover:text-white transition-colors font-semibold flex items-center gap-1">Pay Advance / Online</Link></li>
