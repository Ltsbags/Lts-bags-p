...
export const metadata = generatePageMetadata({
  title: 'About LTS BAGS PRIVATE LIMITED | Custom B2B Bag Factory',
  description: 'Learn about LTS BAGS PRIVATE LIMITED, a premier OEM/ODM bag factory specializing in corporate backpacks, laptop briefcases, travel luggage, and wholesale supply.',
  path: '/about',
});
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="mt-4 max-w-3xl space-y-3">
              ...
              <h1 className="text-3xl sm:text-5xl font-black tracking-tight font-serif text-white">
                About LTS BAGS PRIVATE LIMITED
              </h1>
              <p className="text-slate-300 text-base leading-relaxed">
                Empowering international corporations, brand distributors, and retail chains with state-of-the-art bag production, strict quality control, and direct factory pricing.
              </p>
            </div>
          </div>
        </section>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
              ...
              <div className="lg:col-span-6 space-y-5">
                ...
                <h2 className="text-3xl font-black text-slate-900 font-serif leading-tight">
                  Over a Decade of Engineering Premium Luggage & Custom Corporate Bags
                </h2>
                <p className="text-slate-600 text-sm leading-relaxed">
                  LTS BAGS PRIVATE LIMITED operates a modern manufacturing facility equipped with computerized pattern lasers, heavy-duty bar-tacking stitch machines, and automated hydraulic embossing presses.
                </p>

                <p className="text-slate-600 text-sm leading-relaxed">
                  We specialize in OEM (Original Equipment Manufacturing) and ODM (Original Design Manufacturing) solutions for corporate employee onboarding kits, IT tech companies, university athletic programs, and retail bag exporters.
                </p>
              ...
              <div className="lg:col-span-6">
                <div className="relative rounded-2xl overflow-hidden shadow-xl border border-slate-200 bg-slate-100">
                  <img
                    ...
                    alt="ApexBags Manufacturing Workshop Floor"
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-slate-950/80 via-transparent to-transparent flex items-end p-6">
                    <div className="text-white space-y-1">
                      ...
                      <p className="text-xs text-slate-300">Precision quality inspection on every batch before packaging.</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="bg-gradient-to-br from-slate-900 to-slate-800 text-white rounded-2xl p-8 sm:p-12 border border-slate-700 shadow-xl grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
              ...
              <div className="lg:col-span-8 space-y-4">
                <span className="text-amber-400 font-bold text-xs uppercase tracking-widest font-mono bg-amber-500/10 px-3 py-1 rounded-full border border-amber-500/20">
                  ISO 9001:2015 & BSCI Compliant Plant
                </span>
                ...
                <p className="text-slate-300 text-xs sm:text-sm leading-relaxed">
                  Every bag manufactured in our factory adheres to stringent ethical labor standards, zero child labor policies, and eco-conscious waste recycling. Fabrics undergo REACH and OEKO-TEX chemical compliance verification to ensure complete consumer safety.
                </p>
              </div>
              ...
              <div className="lg:col-span-4 flex flex-col gap-3">
                ...
                >
                  ...
                  <span>Speak with Factory Director</span>
                </a>
              </div>
